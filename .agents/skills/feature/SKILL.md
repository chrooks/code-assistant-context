...
2. Read `~/.codex/PLAN.md` for the ExecPlan skeleton and requirements. Write the plan to `feature_requests/<feature-slug>-plan.md` following that skeleton exactly. Fill in every section — do not leave placeholder text.
...
These let you re-enter the workflow mid-stream (e.g. after reopening Codex):
